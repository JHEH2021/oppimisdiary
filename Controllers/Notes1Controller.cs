...
namespace Oppimispäiväkirja_versio1.Controllers
{
    public class Notes1Controller : Controller
    {
        ...
        public Notes1Controller(Oppimispäiväkirja_versio1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NoteText")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NoteText")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
